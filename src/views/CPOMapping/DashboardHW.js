...
const dashboard_filter = "26.06.2020_80% billing upon HW COA_batch 1";

class Pivot2 extends React.Component {
  DistictData(all_data) {
    const result = [
      ...all_data
        .reduce((a, b) => {
    ...
    getDatafromAPINODE(
      ...
      if (res.data !== undefined) {
        ...
        const filter_items = items
          .filter((item) => item.Billing_Upon_Hw_Coa_80 === dashboard_filter)
