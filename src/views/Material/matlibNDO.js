...
class MatNDO extends React.Component {
  ...
  exportMatStatus = async () => {
    ...
    let header = [
      "Material_Type",	"MM_Code",	"MM_Description",	"UoM",	"Unit_Price",	"BB",	"BB_Sub",	"Region",	"Remarks_or_Acceptance",	"SoW_Description_or_Site_Type",	"Vendor_ID",	"Vendor_Name",	"Note",
    ];    

    ws.addRow(header);

    ws.addRow([
      modul_name,	"MM_Code",	"MM_Description",	"UoM",	1000,	"BB",	"BB_Sub",	"Region",	"Remarks_or_Acceptance",	"SoW_Description_or_Site_Type",	"Vendor_ID",	"Vendor_Name",	"Note",
