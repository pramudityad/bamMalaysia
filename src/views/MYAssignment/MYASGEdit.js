...
class MYASGEdit extends Component {
    ...
    this.getDatafromAPIMY('/prpo_data?where={"LMR_No" : "'+LMR_ID+'"}').then(
      (res) => {
        if (res.data !== undefined) {
          ...
          // console.log('Item_Category ',this.state.list_pr_po.map(e => e.Item_Category))
        }
      }
    );
  }
  ...
  handleChangeFormLMRChild(e) {
    let dataLMR = this.state.list_pr_po;
    // console.log('dataLMR ', dataLMR)
    ...
    this.setState({ list_pr_po: dataLMR });
    console.log('list_pr_po ', this.state.list_pr_po)
  }
  ...
  //   const newLMRChild = this.state.list_pr_po.map((lmr, sidx) => {
  ...
  //   this.setState(
  //     {
  //       list_pr_po: newLMRChild,
  //     },
  //     () => console.log('lmr child ',this.state.list_pr_po)
  //   );
  // };
          ...
          <Col xl="12">
            <Card>
              ...
              <CardBody>
                    ...
                    <Col md={4}>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="lmr_issued_by"
                          id="lmr_issued_by"
                          value={this.state.list_pr_po.map(e => e.Requisitioner)}
                          onChange={this.handleChangeFormLMR}
                          disabled
                        />
                      </FormGroup>
                ...
                <hr className="upload-line--lmr"></hr>
                {this.state.list_pr_po.map((lmr, i) => (
                  <Form>
                    <Row form>
                      <Col md={2}>
                        <FormGroup>
