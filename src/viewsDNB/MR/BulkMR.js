...
class BulkMR extends Component {
  ...
  exportFormatBulkMRMigration = async () =>{
    ...
    ws.addRow([
      "id",
      "mr_mitt_no", "mr_creation_date", "mr_creation_by",
      "project_name",
      "mr_type",
      "mr_delivery_type",
      "origin_warehouse",
    ...
    ws.addRow(["new", null, null, null, "XL BAM DEMO 2020",	"1",	"1",	"JKT1",	"2020-04-19",	"2020-04-21",	"2000057356", null, null, "tower_id", "JAW-JT-BBS-0001"]);
    ws.addRow(["new", null, null, null, "XL BAM DEMO 2020",	"1",	"1",	"JKT1",	"2020-04-19",	"YYYY-MM-DD",	"DSP", null, null, "cd_id", "X2660930"]);

    const MRFormat = await wb.xlsx.writeBuffer();
    saveAs(new Blob([MRFormat]), 'MR Uploader Template Migration.xlsx');
  }
      ...
      <div>
        ...
        <Card>
          <CardHeader>
            ...
            <Button style={{marginRight : '8px', float : 'right'}} outline color="info" onClick={this.exportFormatBulkMRMigration} size="sm"><i className="fa fa-download" style={{marginRight: "8px"}}></i>Download MR Format Migration</Button>
          </CardHeader>
              ...
              <Row>
                ...
                <Col sm="4" lg="4">
                  <Table hover bordered responsive size="sm" style={{width : '100%'}}>
                    <thead>
                      <tr style={{backgroundColor : "rgb(11, 72, 107)", color: "white"}}>
                        <td colSpan="2">Additional MR Reason</td>
                      </tr>
                      <tr>
                        <th>Code</th>
                        <th>Name</th>
