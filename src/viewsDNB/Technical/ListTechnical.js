...
class ListTechnical extends Component {
  ...
  getTechBoqList() {
    let filter_no_tech =
      this.state.filter_list[1] === null
        ? '"no_tech_boq":{"$exists" : 1}'
        : '"no_tech_boq":{"$regex" : "' +
          this.state.filter_list[1] +
          '", "$options" : "i"}';
    let filter_project =
      this.state.filter_list[2] === null
        ? '"project_name":{"$exists" : 1}'
        : '"project_name":{"$regex" : "' +
          this.state.filter_list[2] +
          '", "$options" : "i"}';
    let filter_ver =
      this.state.filter_list[4] === null
        ? '"version":{"$exists" : 1}'
        : '"version":{"$regex" : "' +
          this.state.filter_list[4] +
          '", "$options" : "i"}';
    let filter_status =
      this.state.filter_list[5] === null
        ? '"approval_status":{"$exists" : 1}'
        : '"approval_status":{"$regex" : "' +
    ...
    let filter_status =
      this.state.filter_list[5] === null
        ...
        : '"rev":{"$regex" : "' +
          this.state.filter_list[5] +
          '", "$options" : "i"}';
    let filter_project_note =
      this.state.filter_list[7] === null
        ? ""
        : ', "note_6":{"$regex" : "' +
  ...
  deleteTechBoq(e) {
    ...
    const delTech = this.deleteDataFromAPINODE(
      "/techBoq/deleteOneTechBoq/" + _id_tech
    );
  }
                        ...
                        <div className="controls">
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              value={this.state.filter_list[1]}
                            />
                          </InputGroup>
                        </div>
                      </td>
                        ...
                        <div className="controls">
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              size="sm"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[2]}
                            />
                          </InputGroup>
                        </div>
                      </td>
                        ...
                        <div className="controls">
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              size="sm"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[4]}
                            />
                          </InputGroup>
                        </div>
                      </td>
                        ...
                        <div className="controls">
                          <InputGroup className="input-prepend">
                            ...
                            <Input
                              ...
                              size="sm"
                              onChange={this.handleFilterList}
                              value={this.state.filter_list[5]}
                            />
                          </InputGroup>
                        </div>
                      </td>
                  ...
                  <tbody>
                    {this.state.list_tech_boq.map((boq, i) => (
                      <tr key={boq._id}>
                        ...
                        >
                          {boq.approval_status === "PRE APPROVAL" ||
                          boq.approval_status === "REJECTED" ? (
                            <span className="boq-tech-status-PA">
                              {boq.approval_status}
                            </span>
                          ) : boq.approval_status === "REQUEST FOR APPROVAL" ? (
                            <span className="boq-tech-status-WA">
                              {boq.approval_status}
                            </span>
                          ) : (
                            <span className="boq-tech-status-A">
                              {boq.approval_status}
                            </span>
                          )}
                        </td>
