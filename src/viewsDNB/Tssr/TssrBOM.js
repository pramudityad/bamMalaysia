...
class TssrBOM extends Component {
  ...
  getDataProject() {
    this.getDatafromAPIXL('/project_sorted_non_page?where={"BOQ_Project" : true}').then( resProject => {
              ...
              <Table hover bordered striped responsive size="sm">
                ...
                <tbody>
                  {this.state.data_tssr_selected.map( tssr =>
                      tssr.listOfPackage.filter(dp => dp.product_type.toLowerCase() !== "svc" && dp.product_type.toLowerCase() !== "hwac" && dp.product_type.toLowerCase() !== "sw").map( pp =>
                        <Fragment>
