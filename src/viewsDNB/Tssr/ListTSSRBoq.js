...
const array_field = ["no_tssr_boq", "project_name", "creator", "version", "current_status"];
...
class ListTSSRBoq extends Component {
  ...
  getTechBoqList(){
    ...
    this.getDataFromAPINODE('/tssr/getTssr?srt=_id:-1&'+where+'&lmt='+ this.state.perPage +"&pg=" + this.state.activePage).then(res => {
