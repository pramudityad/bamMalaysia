...
class PackageUpload extends React.Component {
  ...
  getPackageDataAPI() {
    ...
    let whereOr =
      '{"pp_id": {"$ne":"AdditionalMaterial"},"$or" : [{"product_name": ' +
      filter +
      '}, {"pp_cust_number": ' +
      filter +
      '}, {"physical_group": ' +
  ...
  exportFormatPSWarehouse = async () => {
    ...
    saveAs(
      new Blob([MaterialFormat]),
      "PS MR Warehouse Uploader Template.xlsx"
    );
  };
  ...
  async exportFormatBundleMaterial() {
    ...
    saveAs(
      ...
      "Bundle Material Uploader Template.xlsx"
    );
  }
                  ...
                  <div style={{ marginRight: "10px" }}>
                    ...
                    >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownItem onClick={this.exportFormatPackage}>
                          > Bundle Template
                        </DropdownItem>
                        <DropdownItem
                          onClick={this.exportFormatMaterial}
                        ...
                        <DropdownItem
                          onClick={this.exportFormatConfigVertical}
                          disabled={this.state.packageChecked.length === 0}
                        >
                          > Config Template
                        </DropdownItem>
                        ...
                        <DropdownItem
                          onClick={this.exportFormatPSWarehouse}
                          disabled={this.state.packageChecked.length === 0}
                        >
                          > PS Warehouse Template
                        </DropdownItem>
                ...
                <Card style={{ margin: "10px 10px 5px 10px" }}>
                  ...
                  <CardFooter>
                    ...
                    <Button
                      ...
                      size="sm"
                      disabled={this.state.rowsXLS.length === 0}
                      onClick={this.saveProductPackage}
                    >
                      {" "}
                        ...
                        >
                          <tr align="center">
                            <th>
                              <Checkbox
                                name={"all"}
                                checked={this.state.packageChecked_page}
